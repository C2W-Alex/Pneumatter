...
public abstract class RitualCommitment extends RitualBase {

    public RitualCommitment(EntityPlayer player, World world, long duration, long fullDuration, BlockPos pos){
